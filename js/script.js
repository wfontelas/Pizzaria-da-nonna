...
const adicionarNoCarrinho = () => {
    seleciona('.pizzaInfo--addButton').addEventListener('click', () => {
        ...
        //concatene as duas informações separadas por um símbolo, vc escolhe
...
const fecharCarrinho = () => {
    ...
    seleciona('.menu-closer').addEventListener('click', () => {
        seleciona('aside').style.left = '100vw' // usando 100vw ele ficaria fora da tela
...
const atualizarCarrinho = () => {
    ...
    if (cart.length > 0) {
        ...
        for (let i in cart) {
            //use o find para pegar o objeto por id
